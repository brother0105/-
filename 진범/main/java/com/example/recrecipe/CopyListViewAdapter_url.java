...
public class CopyListViewAdapter_url extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        //여기에 위젯마다 클릭 이벤트시 컨트롤
/*
        titleTextView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                gotointent(listViewItem.getTitle());
            }
        });
...
*/
    ...
    public String gotointent(long a){
        CopyRecipeListViewItem item = new CopyRecipeListViewItem();

        return listViewItemList.get((int)a).getTitle();
    }
}