...
public class TestR extends AppCompatActivity {
    ...
    private static String IP_ADDRESS = "192.168.219.178";
    private static String TAG = "phptest";

    private EditText mEditTextName;
    private EditText mEditTextCountry;
    private TextView mTextViewResult;
    private ArrayList<TestpersonalData> mArrayList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new TestAdapter(this, mArrayList);
    ...
    private class GetData extends AsyncTask<String, Void, String>{
        ...
        protected void onPreExecute() {
            ...
            progressDialog = ProgressDialog.show(TestR.this,
    ...
    private void showResult(){
        ...
        try {
            ...
            for(int i=0;i<jsonArray.length();i++){
                ...
                TestpersonalData personalData = new TestpersonalData();

                personalData.setMember_id(id);
                personalData.setMember_name(name);
                personalData.setMember_ingredient(ingredient);
                personalData.setMember_recipe(recipe);
